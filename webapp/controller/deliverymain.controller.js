sap.ui.define(
	...
	return BaseController.extend("cie.delivery.controller.deliverymain", {
			...
			onPrint: function(oEvent){
				...
				if (selectIndexArry.length <= 0) {
					...
					for (i=0;i<ditem.length;i++){
						...
						printArr.push({
							Name: "A3_barcode_2D",
							Value: "[)>_1E06_1DP" + ditem[i].MaterialByCustomer + "_1DQ" + QTYPerPack + "_1D1JUN545301053" + ditem[i].Batch
									+ "_1D20L" + ditem[i].MaterialHandlingCo + "_1D21L" + ShipTo + "_1D15K" + KANBANNumber + "_1DB" + TypeofPackages
									+ "_1D7Q" + Headergrossweight +"GT_1D2S" + ditem[i].DeliveryDocument + "_1E_04" // "_1D" + 16D20190811+"_1E_04"
						});
						printArr.push({
							Name: "D1_barcode",
						...
						var current = this.callZPLService(sUrl, oRequest,currentnum,sumnum);
						// if (oRequest==="") {
			...
			callZPLService: function(oUrl,oRequest,num,sum){
			var that = this;
			var messageText = "";
